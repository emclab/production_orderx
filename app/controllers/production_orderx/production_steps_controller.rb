...
module ProductionOrderx
  class ProductionStepsController < ApplicationController
    ...
    def load_record
      ...
      @part_production = ProductionOrderx::PartProduction.find_by_id(ProductionOrderx::ProductionStep.find_by_id(params[:production_step][:part_production_id]).part_production_id) if params[:production_step][:part_production_id].present?
    end
