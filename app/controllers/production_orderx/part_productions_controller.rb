...
module ProductionOrderx
  class PartProductionsController < ApplicationController
    ...
    def load_record
      ...
      @order = ProductionOrderx.order_class.find_by_id(ProductionOrderx::PartProduction.find_by_id(params[:part_production][:order_id].to_i).order_id) if params[:part_production] && params[:part_production][:order_id].present?
