module ProductionOrderx
  class PartProduction < ActiveRecord::Base
    attr_accessor :customer_name, :last_updated_by_name, :step_status_name, :order_manager_name, :sales_name
    ...
    belongs_to :order_manager, :class_name => 'Authentify::User'
    ...
    validates :sales_id, :numericality => {:greater_than => 0}, :if => 'sales_id.present?'
